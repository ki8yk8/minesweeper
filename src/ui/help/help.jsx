				...
				<>
					...
					>
						...
						<p style={{ fontSize: "0.8rem" }}>
							The game is same as minesweeper, rules are the same. Your goal is
							to not hit the mines while revealing all the cells.{" "}
						</p>
						<p style={{ fontSize: "0.8rem", marginTop: "0.5rem" }}>
							As you complete the game, you get certain number of coins equal to
							the number of bombs in the level. With those coins, you will be
							able to unlock different powerups.
						</p>
						<p
							style={{
								fontSize: "0.8rem",
